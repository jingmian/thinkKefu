<?php /*a:1:{s:63:"E:\efarsoft\thinkKefu\application\service\view\index\index.html";i:1572315987;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin" id="content">
    <div class="layui-header">
        <div class="layui-logo" style="color: white">共享仓超客服【工作台】</div>
        <ul class="layui-nav layui-layout-right" style="margin-top: 10px;" >
            <li style="display: inline-block;">
                <button class="layui-btn layui-bg-red"  onclick="loginOut()">
                    <i class="layui-icon">&#xe609;</i> 退出下班
                </button>
            </li>
            <li style="display: inline-block;">
                <button class="layui-btn layui-btn-normal" id="fullScreen">
                    <i class="layui-icon">&#xe638;</i> 全屏
                </button>
            </li>
        </ul>
    </div>
    ...
    <div class="layui-body" style="bottom:0">
        ...
        <div style="width:20%;height:100%;float:left;margin-left:1%">
...
<script>
    var servicer = {
        "uid":"<?php echo htmlentities($servicer['id']); ?>",
        'nickname':"<?php echo htmlentities($servicer['nick_name']); ?>",
        'avatar':"<?php echo htmlentities($servicer['avatar']); ?>",
        "group":"<?php echo htmlentities($servicer['is_kefu']); ?>"
    } ;
